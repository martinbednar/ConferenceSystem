...
namespace ConferencySystem.BL.Services
{
    public class ExportService
    {
        ...
        public List<UserCompletInfo> GetAllUsersData()
        {
            using (var db = new DbContext())
            {
                var query = db.Users.Select(p => new AppUserDTO()
        ...
        public List<UserCompletInfo> GetAllVisitorsData()
        {
            using (var db = new DbContext())
            {
                var query = db.Users.Select(p => new AppUserDTO()
        ...
        public List<UserCompletInfo> GetAllLecturersData()
        {
            using (var db = new DbContext())
            {
                var query = db.Users.Select(p => new AppUserDTO()
