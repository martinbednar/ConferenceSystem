...
namespace ConferencySystem.ViewModels.Admin
{
    ...
    public class ExportVisitorsViewModel : MainMasterPageViewModel
    {
        ...
        public override Task PreRender()
        {
            ...
            exportService.GetAllVisitorsData(Users);
        ...
        public void ExportToExcel()
        {
            ...
            {
                Context.ReturnFile(file, "NakopneteSvojiSkolu-VystavovateleHosteATymKompletniPrehled.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
            }
        }
    }
}